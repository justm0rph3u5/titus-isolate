...
OVERSUBSCRIBE_DELAY_SECONDS_KEY = 'TITUS_ISOLATE_OVERSUBSCRIBE_DELAY_SECONDS'
DEFAULT_OVERSUBSCRIBE_DELAY_SECONDS = 60

CPU_PREDICTOR = 'TITUS_ISOLATE_CPU_PREDICTOR'
LEGACY_CPU_PREDICTOR = 'legacy'
SERVICE_CPU_PREDICTOR = 'service'
DEFAULT_CPU_PREDICTOR = LEGACY_CPU_PREDICTOR
...
DEFAULT_GET_WORKLOAD_RETRY_INTERVAL_SEC = 0.1
